        ...
        <>
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerText}>studnet cvs</Text>
                </View>
                ...
                <TouchableOpacity style={styles.addButton} activeOpacity={0.8} onPress={() => props.navigation.navigate("createJobPost")} >
